...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  const { user, loading, isAuthenticated, logout, callbackError, recoveryMode, completeRecovery } = useAuth();
  ...
  if (recoveryMode) return <AuthGate recoveryMode onRecoveryComplete={completeRecovery} />;
